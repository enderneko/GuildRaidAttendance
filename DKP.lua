...
function GRA.UndoDKP(dkpDate, index)
    local t = GRA_Logs[dkpDate]["details"][index]
    ...
    table.remove(GRA_Logs[dkpDate]["details"], index)
    GRA.Fire("GRA_ENTRY_UNDO", dkpDate)
end
...
function GRA.AwardDKP(dkpDate, dkp, reason, players, note)
    ...
    table.insert(GRA_Logs[dkpDate]["details"], dkpTable)

    GRA.Fire("GRA_ENTRY", dkpDate)
end
...
function GRA.ModifyDKP_A(dkpDate, dkp, reason, players, index)
    ...
    GRA_Logs[dkpDate]["details"][index] = {"DKP_A", dkp, reason, players}
    GRA.Fire("GRA_ENTRY_MODIFY", dkpDate)
end
...
function GRA.ModifyDKP_C(dkpDate, dkp, reason, looter, note, index)
    ...
    GRA_Logs[dkpDate]["details"][index] = {"DKP_C", dkp, reason, looter, note}
    GRA.Fire("GRA_ENTRY_MODIFY", dkpDate)
end
...
function GRA.ModifyPenalizeDKP(pDate, value, reason, players, index)
    ...
    GRA_Logs[pDate]["details"][index] = {"DKP_P", value, reason, players}
...
local function UpdateRosterDKP(event, name, note)
    ...
    GRA_Roster[name]["DKP_Current"] = current
    GRA_Roster[name]["DKP_Spent"] = spent
    GRA_Roster[name]["DKP_Total"] = total
